...
$('.wheel-table-cart .fa-times').on('click', function (e) {
   $(this).parent().parent().remove();
    ...
    $('.reservation .containe label.promo button').on('click', function(event) {
        event.preventDefault();
        window.location.href = "reservation3.html";
    });
    $('container wheel-order label.promo button').on('click', function(event) {
        event.preventDefault();
