            ...
            <div class="row">
                <div class="col-md-6 ">
                    <div class="wheel-info-img  marg-lg-t150 marg-lg-b150 marg-md-t100 marg-md-b100">
                        <img src="resources/KhachHang/images/i7.png" alt="" class="wheel-img">
                    </div>
                </div>
                <div class="col-md-6 ">
                    <div class="wheel-info-text  marg-lg-t150 marg-lg-b150 marg-md-t100 marg-md-b100 marg-sm-t50 marg-sm-b50">
                        <div class="wheel-header">
                            ...
                            <h3><span>Chất lượng</span> là  <span>Danh dự</span></h3>
                        </div>
                        <span>Công ty Wheel được thành lập năm 2001. Trải qua 20 năm phát triển đặt khách hàng làm trọng tâm, chúng tôi tự hào trở thành doanh nghiệp vận tải nòng cốt góp phần phát triển ngành vận tải của cả nước.</span>
                        <p>Tuân thủ phương châm<span> “Chất lượng là danh dự”</span> , công ty hiện đang khai thác hơn 60 chuyến vận tải hành khách liên tỉnh cố định trải dài từ Nam ra Bắc với hơn 250 phòng vé và trạm trung chuyển, hơn 2000 đầu xe các loại, phục vụ hơn 20 triệu khách mỗi năm </p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="wheel-header wheel-testi-header text-center marg-lg-t145 marg-lg-b65 marg-md-t100 marg-sm-t50 marg-md-b50">
                            <h3>Whell - <span>"Chất lượng là danh dự"</span></h3>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12 padd-lr0 ">
                        <div class="wheel-testimonial-item marg-lg-b130 marg-md-b100 marg-sm-b50 ">
                            <i class="fa fa-users"></i>
                            <span data-to="9999" data-speed="5000"></span><b>+</b>
                            <p>Hơn 9999 lượt khách</p>
                            <h5>Whell phục vụ hơn 9999 lượt khách/năm</h5>
                        </div>
                        <div class="wheel-testimonial-item marg-lg-b130 marg-md-b100 marg-sm-b50">
                            <i class="fa fa-thumbs-o-up"></i>
                            <span data-to="90" data-speed="5000"></span><b>%</b>
                            <p>Chất lượng phục vụ</p>
                            <h5>Hơn 90% hành khách hài lòng về chất lượng dịch vụ </h5>
                        </div>
                        <div class="wheel-testimonial-item marg-lg-b130 marg-md-b100 marg-sm-b50">
                            <i class="fa fa-building"></i>
                            <span data-to="100" data-speed="5000"></span><b>+</b>
                            <p>Hơn 100 phòng vé</p>
                            <h5>Whell có hơn 100 phòng vé, bến xe khắp cả nước</h5>
                        </div>
                        <div class="wheel-testimonial-item marg-lg-b130 marg-md-b100 marg-sm-b50">
                            <i class="fa fa-car"></i>
                            <span data-to="632" data-speed="1000"></span><b>+</b>
                ...
                <div class="col-md-6 padd-lr0">
                    <div class="wheel-info-text2 marg-lg-t140 marg-lg-b150 marg-md-t100 marg-md-b50 ">
                        <div class="wheel-header">
                            ...
                            <h3>Chúng tôi đang nỗ lực trở thành nhà xe uy tín và chất lượng nhất cả nước với những<span> cam kết </span> : </h3>
                        </div>
                        <div class="wheel-skills-accordion ">
                                <div class="wpc-accordion">
                                    <div class="panel-wrap active">
                                        <h5 class="panel-title">Tạo ra môi trường là việc năng động, thân thiện<span></span></h5>
                                        <div class="panel-content">
                                            Đội ngũ nhân viên được đào tạo bài bản và luôn lắng nghe theo yêu cầu của khách hàng
                                        </div>
                                    </div>
                                    <div class="panel-wrap">
                                        <h5 class="panel-title">Phát triển từ lòng tin của khách hàng <span></span></h5>
                                        <div class="panel-content">
                                            Whell cam kết mang lại cho khách hàng chuyến đi an toàn, thoải mái với mức giá phù hợp
                                        </div>
                                    </div>
                                    <div class="panel-wrap">
                                        <h5 class="panel-title">Phấn đấu làm việc để trở thành nhà xe hàng đầu <span></span></h5>
                                        <div class="panel-content">
                                            Trong xu hướng 4.0 hiện nay, chúng tôi cũng đang ứng dụng và phát triển những công nghệ quảng cáo kỹ thuật số và phát triển trang web
                                        </div>
                                    </div>
                                </div>
                         </div>
            ...
            <div class="container padd-lr0">
                ...
                <div class="row">
                    <div class="col-md-4 padd-l0  padd-md-lr15">
                        <div class="wheel-news-item text-center ">
                            <div class="wheel-news-item-img">
                                <img src="resources/KhachHang/images/Co-Founder.png" alt="">
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="wheel-news-item text-center ">
                            <div class="wheel-news-item-img">
                                <img src="resources/KhachHang/images/Founder.png" alt="">
                            </div>
                            <div class="wheel-team-info ">
                                <h5>Quang Huy</h5>
                                <span> Founder</span>
