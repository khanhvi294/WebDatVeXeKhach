...
<head>
    ...
    <body class="">
        ...
        <div class="wheel-register-block">
            ...
            ${message3 }
                <div class="row">
                    <div class="col-lg-12 marg-lg-t150 marg-lg-b150 marg-sm-t100 marg-sm-b100 ">             
                        <div class="card">
                          <div class="card-body">
                            <form class="row g-3" method="post">
                              <div class="col-md-12" style="margin-top:40px">
                                <label for="inputName5" class="form-label">Mật khẩu cũ</label>
                                <input name="cpassword" type="password" class="form-control" id="inputName5">
                              </div>
                              ${message }
                              <div class="col-md-12">
                                <label for="inputName5" class="form-label">Mật khẩu mới</label>
                                <input name="npassword" type="password" class="form-control" id="inputName5">
                              </div>
                              <div class="col-md-12">
                                <label for="inputName5" class="form-label">Xác nhận mật khẩu</label>
                                <input name="rnpassword" type="password" class="form-control" id="inputName5">
                              </div>
                              ${message2 }
