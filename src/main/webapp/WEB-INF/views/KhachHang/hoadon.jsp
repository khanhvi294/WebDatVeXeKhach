							...
							<div class="receipt-header receipt-header-mid">
								<div class="col-xs-8 col-sm-8 col-md-8 text-left">
									<div class="receipt-right">
										...
										<p>
											<b>Số điện thoại : ${phieudat.sdt}</b>
										</p>
										<p>
											<b>Email: ${phieudat.email}</b>
										</p>
									</div>
								</div>
						...
						<div>
							<table class="table table-bordered">
								<thead>
									...
									<th colspan="2"><span style=""> Thông tin chuyến:&nbsp;&nbsp; <span style="font-size: 17px;">
												${phieudat.chuyen.tuyen.diemDi.diaDiem}</span> &nbsp;&nbsp;=>&nbsp;&nbsp; <span style="font-size: 17px;">
												${phieudat.chuyen.tuyen.diemDen.diaDiem} </span></span></th>


								</thead>
								<tbody>
									<tr>
										<td colspan="2" class="col-md-3"><br> Thời gian khởi
											hành : ${phieudat.chuyen.tgKh} ngày ${phieudat.chuyen.ngKH} <br>
											Số lượng ghế : ${soluong } <br> Số ghế: <c:forEach
												var="ve" items="${ phieudat.vexe}">
												<br>
                                            ${ve.id.soGhe }
                                            </c:forEach></td>
									...
									<tr>
										...
										<td class="text-left text-danger">
											<h2>
												<strong> ${phieudat.chuyen.gia} VNĐ</strong>
											</h2>
										</td>
									</tr>
								</tbody>
						...
						<div class="row">
							<div class="receipt-header receipt-header-mid receipt-footer">
								<div class="col-xs-8 col-sm-8 col-md-8 ">
									<div class="receipt-right">
										<p>
											<b>Ngày đặt:</b> ${phieudat.ngaydat}
										</p>
										<h5 style="color: rgb(140, 140, 140);">Cảm ơn vì đã tin
											tưởng hãng xe của chúng tôi</h5>
