								...
								<tr>
									...
									<td><c:choose>
											<c:when test="${u.trangThai eq 0}">
												<span class="badge rounded-pill bg-info v-bg-tt">Chờ
													Thanh Toán</span>
											</c:when>
									...
									<td><span><a
											href="/CNPM/quanly/phieudat/${u.maPD}.html?info"> <i
												class="bi bi-info-circle-fill v-icon-modal"></i>
										</a> <c:if test="${u.trangThai!=2}">
												<a href="/CNPM/quanly/phieudat/${u.maPD}.html?update"><i
									...
									<div class="card-body pt-3">
										...
										<div class="tab-content pt-2">
											<div class="tab-pane fade show active profile-overview"
												id="profile-overview">
												<div class="row">
													<div class="col-lg-3 col-md-4 label v-label">Mã phiếu
														đặt</div>
													<div class="col-lg-8 col-md-5">${pd.maPD }</div>
												</div>

												<div class="row">
													<div class="col-lg-3 col-md-4 label v-label">Khách
														hàng</div>
													<div class="col-lg-8 col-md-5">${pd.KH.hoKH}
														${pd.KH.tenKH}</div>
												</div>

												<div class="row mt-3">
													<h5 class="col-lg-6 col-md-6 label v-label">Thông tin
														chuyến xe</h5>
												</div>
													...
													<div class="col-12">
														<div class="row"
															...
															<div class="col-lg-8 col-md-5">
																${pd.chuyen.tuyen.diemDi.diaDiem} -
																${pd.chuyen.tuyen.diemDen.diaDiem}</div>
														</div>
												...
												<div class="row">
													<div class="col-6" style="border: solid 1px #000">
														...
														<div class="row" style="border-bottom: solid 1px #000";>
															<div class="col-lg-6 col-md-6 label v-label">STT</div>
															<div class="col-lg-6 col-md-6 label v-label">Số ghế
															</div>
														</div>
														<c:forEach var="u" items="${vx}">
															<div class="row">
																<div class="col-lg-6 col-md-6">${u.key}</div>
												...
												<div class="row">
													<div class="col-lg-3 col-md-4 label v-label">Tổng
														tiền</div>
													<div class="col-lg-8 col-md-5">
														<h5>${pd.tongtien }</h5>
													</div>
												...
												<div class="row">
													...
													<c:choose>
														<c:when test="${pd.trangThai == 0}">
															<div class="col-lg-8 col-md-5">Chờ thanh toán</div>
														</c:when>
														<c:when test="${pd.trangThai == 1}">
															<div class="col-lg-8 col-md-5">Đã thanh toán</div>
														</c:when>
												...
												<div class="row">
													<div class="col-lg-3 col-md-4 label v-label">Nhân
														viên</div>
													<div class="col-lg-8 col-md-5">${pd.NV.hoNV }
														${pd.NV.tenNV }</div>
												</div>
											</div>
										</div>
