                    ...
                    <div class="card">
                        <div class="card-body pt-3">
                            ...
                            <ul class="nav nav-tabs nav-tabs-bordered">
                                <li class="nav-item ">
                                    <a href="/CNPM/quanly/trangcanhan.html"><button class="nav-link v-nav-link active v-active">Chỉnh sửa thông tin</button></a>
                                </li>
                            ...
                            <div class="tab-content pt-2">
                                <div class="tab-pane fade show active profile-edit pt-3" id="profile-edit">
                                    ...
                                    <!-- Profile Edit Form -->
                                    <form:form action = "quanly/trangcanhan.html" method = "post" modelAttribute="nv">
                                        <div class="row mb-3">
                                            <label for="fullName" class="col-md-4 col-lg-3 col-form-label v-label">Mã
                                                nhân
                                                viên</label>
                                            <div class="col-md-8 col-lg-9">
                                                <form:input path="maNV" type="text" class="form-control v-form-control"
                                                     id="fullName" readonly = "true" value="${nv.maNV }"/> 
                                            </div>
                                        </div>
...
<%-- 											</c:choose> --%>
												<div class="form-check form-check-inline ">
	                                                    <form:radiobutton class="form-check-input v-check-input shadow-none"
	                                                        value = "1" path = "phai"/>
